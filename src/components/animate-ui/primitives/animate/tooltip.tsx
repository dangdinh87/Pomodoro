...
const TooltipArrow = React.forwardRef<SVGSVGElement, Omit<TooltipArrowProps, 'ref'>>(
...
const TooltipTrigger = React.forwardRef<HTMLDivElement, Omit<TooltipTriggerProps, 'ref'>>(
  ({
    onMouseEnter,
    onMouseLeave,
    onFocus,
