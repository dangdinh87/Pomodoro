        ...
        <div className="grid gap-5 md:grid-cols-[1fr_220px]">
          <div className="space-y-5 text-sm">
            ...
            <div className="space-y-2.5">
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="low-time-warning">
          ...
          <div className="md:sticky md:top-4">
            <div className="mt-1 md:mt-0">
              <Label className="text-sm font-medium mb-2 block">Xem trước</Label>
              ...
              {localSettings.clockType === 'progress' && (
                <div className="text-center">
                  <div className="text-base font-bold text-[hsl(var(--timer-foreground))] mb-2">
                    {previewTime}
                  </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <circle
                        ...
                        strokeDashoffset={`${2 * Math.PI * 90 * 1}`}
                        strokeLinecap="round"
                      />
                    </svg>
