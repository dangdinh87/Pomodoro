		...
		<div className="aui-thread-welcome-root mx-auto my-auto flex w-full max-w-3xl grow flex-col">
			<div className="aui-thread-welcome-center flex w-full grow flex-col items-center justify-center">
				<div className="aui-thread-welcome-message flex size-full flex-col justify-center px-4">
					...
					<p
						className="aui-thread-welcome-instruction fade-in slide-in-from-bottom-1 animate-in text-muted-foreground/80 text-sm mt-4 delay-100 duration-200 bg-muted/50 rounded-lg px-4 py-2"
						suppressHydrationWarning
					>
						💡 {t("chat.thread.instruction")}
					</p>
				</div>
			</div>
			<ThreadSuggestions />
