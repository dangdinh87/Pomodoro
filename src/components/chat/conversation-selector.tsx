...
export function ConversationSelector({
    ...
    const renderConversationItem = (conversation: Conversation) => (
        <div key={conversation.id} className="group flex items-center gap-1 rounded-sm px-2 hover:bg-accent text-sm py-1.5 focus-within:bg-accent relative">
            <div
            ...
            >
                <MessageSquare className={cn("h-4 w-4 shrink-0",
            ...
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <Button variant="ghost" size="icon" className="h-6 w-6 ml-auto opacity-0 group-hover:opacity-100 transition-opacity focus:opacity-100 data-[state=open]:opacity-100">
                ...
                >
                    <div className="flex items-center gap-2 truncate">
                        ...
                        <span className="truncate">
                            {selectedConversation?.title || t('chat.newChat')}
                        </span>
                    </div>
