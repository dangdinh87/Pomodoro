...
export const LimelightNav = ({
  ...
  // Sync internal activeIndex with defaultActiveIndex prop
  useEffect(() => {
  ...
  return (
    <nav className={cn('relative inline-flex items-center h-16 rounded-lg bg-background/20 text-foreground border border-border/20 px-2', className)}>
      ...
      <div 
        ...
        className={cn(
          ...
          isReady ? 'transition-[left] duration-700 ease-in-out' : '',
          limelightClassName
        )}
        style={{ left: '-999px' }}
      >
