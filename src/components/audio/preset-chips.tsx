      ...
      <div className="bg-background/40 border rounded-lg overflow-hidden">
        ...
        <div className="relative">
          {builtInScroll.canScrollLeft && (
            <Button variant="ghost" size="icon" aria-label={t('common.scrollLeft')} onClick={builtInScroll.scrollLeft}
          ...
          {builtInScroll.canScrollRight && (
            <Button variant="ghost" size="icon" aria-label={t('common.scrollRight')} onClick={builtInScroll.scrollRight}
