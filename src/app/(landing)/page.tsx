...
export const metadata: Metadata = {
  ...
  description:
    'Improcode Every Day. Boost your productivity with Improcode. Smart Pomodoro timer with AI insights, task management, ambient sounds, and detailed analytics. Free to use.',
